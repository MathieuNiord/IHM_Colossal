...
public class GameResources {
    ...
    public final static MyImageView ACCOUNT_GUY_IM = new MyImageView(
            IMAGE_ACCOUNT_GUY_DEFAULT, IMAGE_ACCOUNT_GUY_BATTLE, IMAGE_ACCOUNT_GUY_OPENING, IMAGE_ACCOUNT_GUY_DEFEAT_ANIM,4, 4);
    public final static MyImageView ZOMBIE_NAZI_IM = new MyImageView(
            IMAGE_NAZI_ZOMBIE_DEFAULT, IMAGE_NAZI_ZOMBIE_BATTLE, IMAGE_NAZI_ZOMBIE_OPENING, IMAGE_NAZI_ZOMBIE_DEFEAT_ANIM,4, 4);
    public final static MyImageView SUPER_NAZI_IM = new MyImageView(
            IMAGE_BOSS_DEFAULT, IMAGE_BOSS_BATTLE, IMAGE_BOSS_OPENING, IMAGE_BOSS_DEFEAT_ANIM,4, 4);
